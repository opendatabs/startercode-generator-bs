...
def _(mo):
    ...
    *Autogenerated Python starter code for dataset with identifier* **{{ DATASET_IDENTIFIER }}**
    """
    )
    return
...
def _(mo):
    ...
    *You can find the dataset [under this link]({{ DATASHOP_LINK }})*.
    """
    )
    return
...
def _(get_dataset):
    # Read the dataset
    df = get_dataset(dataset_id="{{ DATASET_IDENTIFIER }}")
    df
    return (df,)
